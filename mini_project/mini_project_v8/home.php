                    ...
                    <div class="relative5">
                         <table id="showTask" rules="all">
                              ...
                              <?php
                                   ...
                                   {
                                        echo '<tr><th>Task</th><th>Status</th><th>Download(Voice)</th><th>Download(Instrumental)</th><th>Terminate</th></tr>';
                                        ...
                                        foreach($dirArray as $dirData)
                                        {
                                             ...
                                             //流程:先有computing_*檔確認Status，再有output資料夾(包含分離出的2個音檔)
                                             //有computing_，但還沒生成output
                                             if((is_file($dirPath.$dirData.'/computing_1') || is_file($dirPath.$dirData.'/computing_2') || is_file($dirPath.$dirData.'/computing_3')) && !is_dir($dirPath.$dirData.'/output')) 
                                             {
                                                  //tackle with cpu?
                                                  $status = 'Computing';
                                             }
