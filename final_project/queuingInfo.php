                         ...
                         <table id="showTask" rules="all">
                              <tr><th>Number</th><th>User</th><th>UploadTime</th><th>Task</th><th>Status</th><th>Running Node</th></tr>
                                   <?php
                                        ...
                                        array_shift($list);
                                        array_shift($list);
                                        $no_need=['cpuinfo','allList.txt','userList.txt','loadinfo'];
                                        ...
                                        if(count($temp_dir) != 0) 
                                        {
                                             ...
                                             if(count($queuing_tasks_list) != 0) 
                                             {
                                                  ...
                                                  foreach($queuing_tasks_list as $task) 
                                                  {
                                                       ...
                                                       if (in_array('computing_4', $task_files) && empty($matches) && (!in_array('computing_3', $task_files) && !in_array('computing_2', $task_files) && !in_array('computing_1', $task_files))) 
                                                       {
                                                            $computing_node = 'computing_4';
                                                            $computing_check = $task.'/computing_4';
                                                       }
                                                       if (in_array('computing_5', $task_files) && empty($matches) && (!in_array('computing_3', $task_files) && !in_array('computing_2', $task_files) && !in_array('computing_1', $task_files))) 
                                                       {
                                                            $computing_node = 'computing_5';
                                                            $computing_check = $task.'/computing_5';
                                                       }
                                                       if (in_array('computing_6', $task_files) && empty($matches) && (!in_array('computing_3', $task_files) && !in_array('computing_2', $task_files) && !in_array('computing_1', $task_files))) 
                                                       {
                                                            $computing_node = 'computing_6';
                                                            $computing_check = $task.'/computing_6';
                                                       }
                                                       ...
                                                       if (!empty($matches)) {
                                                            ...
                                                            $temp = file($task.'music_info.txt');
                                                            $file_name = $temp[1].'.mp3';
                                                            $file_time = $temp[2];
                                                       }
